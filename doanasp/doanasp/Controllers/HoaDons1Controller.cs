...
namespace doanasp.Controllers
{
    public class HoaDons1Controller : Controller
    {
        ...
        public HoaDons1Controller(ShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("mahoadon,makhachhang,diachi,ghichu,ngaylap,capnhat,trangthai")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("mahoadon,makhachhang,diachi,ghichu,ngaylap,capnhat,trangthai")] HoaDon hoaDon)
        {
